...
You need to do a quick exploratory data analysis of above and below-ground carbon biomass for an area of interest near Lake Tahoe in the Central Sierra, California. A donor has asked you to do this by the end of the week. You go down the hall to the right where the map plotters are, and ask the GIS guy. He peers up above his array of screens, says he's busy working on a dozen other projects, he might be able to get you something in 2 weeks. He suggests you check out Google Earth Engine.
...
var gray = ["paste in the lines of javascript code from Snazzy"];
